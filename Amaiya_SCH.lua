...
function get_sets()
	...
	sets.Precast = {
		main="Pedagogy Staff",sub="Enki Strap",ammo="Incantor Stone",
		head="Nahtirah Hat",body="Anhur Robe",hands="Academic's Bracers +3",legs="Agwu's Slops",feet="Pedagogy Loafers +3",
		ear1="Malignance Earring",ear2="Enchanter's Earring +1",ring1="Weatherspoon Ring",ring2="Kishar Ring",
		neck="Voltsurge Torque",waist="Embla Sash",back={name="Lugh's Cape",augments={'"Fast Cast"+10',}}
	}
	...
	sets.Precast.Grimoire = {head="Pedagogy Mortarboard +3",feet="Academic's Loafers +3"}
	...
	sets.Midcast.Enhancing = {
		...
		head="Telchine Cap",body="Pedagogy Gown +3",hands="Telchine Gloves",legs="Telchine Braconi",feet="Telchine Pigaches",
		ear1="Andoaa Earring",ear2="Enchanter Earring +1",ring1={name="Stikini Ring +1",bag="wardrobe 3"},ring2={name="Stikini Ring +1",bag="wardrobe 1"},
	...
	sets.Midcast.Dark = set_combine(sets.Midcast.MAcc,{
		...
		body="Academic's Gown +3",hands="Academic's Bracers +3",legs="Pedagogy Pants +3",feet="Agwu's Pigaches",
...
function self_command(command)
    ...
    elseif commandArgs[1]:lower() == 'sc' then
        ...
        elseif commandArgs[2]:lower() == 'distortion' or autosc:lower() == 'distortion' then
            send_command('input /p Opening SC: Distortion  MB: Water/Ice; wait .1; input /ja "Immanence" <me>; wait 1.5; input /ma "Luminohelix" <t>; wait 6.0; input /ja "Immanence" <me>; wait 1.5; input /p Closing SC: Distortion; input /ma "Geohelix" <t>')
