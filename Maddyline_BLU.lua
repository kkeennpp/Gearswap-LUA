function get_sets()
	...
	MagicalSpells = S {
		...
		'Molting Plumage','Mortal Ray','Mysterious Light','Nectarous Deluge','Osmosis','Palling Salvo','Plasma Charge','Polar Roar',
	...
	MagicACCSpells = S {
		...
		'Reaving Wind','Sandspin','Sheep Song','Soporific','Sound Blast','Stinking Gas','Temporal Shift','Venom Shell',
	...
	sets.Idle = {
		...
		head="Malignance Chapeau",body="Jhakri Robe +2",hands="Gleti's Gauntlets",legs="Nyame Flanchard",feet="Gleti's Boots",
		ear1="Infused Earring",ear2="Etiolation Earring",ring1={name="Stikini Ring +1",bag="wardrobe 3"},ring2="Gelatinous Ring +1",
		neck="Warder's Charm +1",waist="Fucho-no-Obi",back="Solemnity Cape"
	}
	...
	sets.TP.LowACC = set_combine(sets.TP,{
		...
		ear1="Brutal Earring",ear2="Cessance Earring",ring1="Epona's Ring",ring2="Ilabrat Ring",
		neck="Sanctity Necklace",waist="Sailfi Belt +1",back={name="Rosmerta's Cape",augments={'DEX+20','Accuracy+20 Attack+20','"Store TP"+10','Damage taken-5%'}}
	})

	sets.TP.HighACC = set_combine(sets.TP.LowACC,{})

	sets.TP.Hybrid = set_combine(sets.TP.LowACC,{
		head="Malignance Chapeau",body="Ayanmo Corazza +2",hands="Nyame Gauntlets",legs="Nyame Flanchard",feet="Nyame Sollerets"
	})
	...
	sets.Precast = {
		...
		ear1="Enchanter Earring +1",ear2="Loquacious Earring",ring1="Weatherspoon Ring",ring2="Kishar Ring",
	...
	sets.Midcast.PHY = set_combine(sets.TP,{
		head="Luhlaza Keffiyeh +2",body="Assimilator Jubbah +3",hands="Nyame Gauntlets",legs="Luhlaza Shalwar +3",feet="Luhlaza Charuqs +3",
	})
	...
	sets.Midcast.MAB = {
		...
		neck="Sanctity Necklace",waist="Sacro Cord",back={name="Rosmerta's Cape",augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+10','"Mag.Atk.Bns."+10',}}
	}

	sets.Midcast.MAB.Dark = set_combine(sets.Midcast.MAB,{head="Pixie Hairpin +1",ring1="Archon Ring"})

	sets.Midcast.Buff = {
		head="Luhlaza Keffiyeh +2",body="Assimilator Jubbah +3",hands="Rawhide Gloves",legs="Ayanmo Cosciales +2",feet="Luhlaza Charuqs +3",
		ear1="Enchntr. Earring +1",ear2="Loquac. Earring",ring1={name="Stikini Ring +1",bag="wardrobe 3"},ring2={name="Stikini Ring +1",bag="wardrobe 1"},
		neck="Mirage Stole +1",waist="Witful Belt",back="Cornflower Cape"
	}

	sets.Midcast.MACC = {
		ammo="Pemphredo Tathlum",
		head="Carmine Mask +1",body="Assimilator Jubbah +3",hands="Rawhide Gloves",legs="Luhlaza Shalwar +3",feet="Luhlaza Charuqs +3",
		ear1="Dignitary's Earring",ear2="Gwati Earring",ring1={name="Stikini Ring +1",bag="wardrobe 3"},ring2={name="Stikini Ring +1",bag="wardrobe 1"},
	...
	sets.WS = {
		ammo="Coiste Bodhar",
		head="Nyame Helm",body="Gleti's Cuirass",hands="Nyame Gauntlets",legs="Nyame Flanchard",feet="Nyame Sollerets",
		ear1="Moonshade Earring",ear2="Cessance Earring",ring1="Apate Ring",ring2="Ilabrat Ring",
		neck="Light Gorget",waist="Sailfi Belt +1",back={ name="Rosmerta's Cape",augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}}
	}
	...
	sets.WS["Chant du Cygne"] = set_combine(sets.WS,{
		head="Adhemar Bonnet +1",body="Gleti's Cuirass",hands="Adhemar Wristbands +1",legs="Gleti's Breeches",feet="Gleti's Boots",
	...
	sets.WS["Sanguine Blade"] = set_combine(sets.WS,{
		ammo="Pemphredo Tathlum",
		head="Pixie Hairpin +1",body="Amalric Doublet +1",hands="Jhakri Cuffs +2",legs="Luhlaza Shalwar +3",feet="Amalric Nails +1",
		ear1="Regal Earring",ear2="Friomisi Earring",ring1="Archon Ring",ring2="Shiva Ring +1",
		neck="Sanctity Necklace",waist="Sacro Cord",back={name="Rosmerta's Cape",augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+10','"Mag.Atk.Bns."+10',}}
	})
	...
	sets.WS["Requiescat"] = set_combine(sets.WS,{
		head="Jhakri Coronal +2",body="Jhakri Robe +2",hands="Jhakri Cuffs +2",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2",
